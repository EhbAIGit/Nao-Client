...
topics = ['NAO/POSTURE','NAO/SAY','NAO/MOTION','NAO/BATTERY','NAO/LANGUAGE','NAO/VOCABULARY','NAO/VOLUME','NAO/LISTEN','NAO/EARLEDS','NAO/POSEBALL','NAO/POSEBALLINTRO','NAO/WALK']
language="Dutch"
